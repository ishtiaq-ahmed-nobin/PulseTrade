...
<?php $component->withAttributes([]); ?>
    ...
    <div class="max-w-2xl">
        <form method="POST" action="<?php echo e(route('admin.categories.store')); ?>" class="bg-white rounded-xl border border-navy-100 p-6 space-y-5">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <textarea name="description" id="description" rows="3"
                          class="w-full rounded-lg border-navy-200 text-navy-900 focus:border-pulse-500 focus:ring-pulse-500"
                          placeholder="Optional category description"><?php echo e(old('description')); ?></textarea>
...
<?php endif; ?>
<?php /**PATH E:\xampp\htdocs\idb-project\PulseTrade\resources\views\admin\categories\create.blade.php ENDPATH**/ ?>