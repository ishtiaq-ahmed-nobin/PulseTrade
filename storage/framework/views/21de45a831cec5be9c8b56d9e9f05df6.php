                            ...
                            <td class="px-5 py-3">
                                <div class="flex items-center gap-3">
                                    <div class="w-10 h-10 bg-ivory rounded-lg overflow-hidden shrink-0">
                                        ...
                                        <?php else: ?>
                                            <div class="w-full h-full flex items-center justify-center text-navy-700/20">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\idb-project\PulseTrade\resources\views/admin/products/index.blade.php ENDPATH**/ ?>