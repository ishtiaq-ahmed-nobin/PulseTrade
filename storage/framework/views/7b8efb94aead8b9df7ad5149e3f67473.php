                    ...
                    <table class="w-full text-sm">
                        ...
                        <tfoot>
                            ...
                            <tr class="border-t border-navy-100">
                                ...
                                <td class="px-5 py-2 text-right text-sm text-navy-700"><?php echo e($currency_symbol); ?><?php echo e(number_format($subtotal, 2)); ?></td>
                            </tr>
                            <?php if($order->coupon_code && $order->discount_amount > 0): ?>
                                <tr>
                                    <td colspan="3" class="px-5 py-2 text-right text-sm text-emerald-600">
                                        Discount <span class="font-medium">(<?php echo e($order->coupon_code); ?>)</span>
                                    </td>
                                    <td class="px-5 py-2 text-right text-sm font-medium text-emerald-600">-<?php echo e($currency_symbol); ?><?php echo e(number_format($order->discount_amount, 2)); ?></td>
                                </tr>
                            <?php endif; ?>
                            <tr class="border-t border-navy-100">
        ...
        <div class="space-y-6">
            ...
            <?php if($order->coupon_code && $order->discount_amount > 0): ?>
                <div class="bg-emerald-50 rounded-xl border border-emerald-200 p-5">
                    ...
                    <div class="space-y-2 text-sm">
                        <p class="text-emerald-700"><span class="text-emerald-600/60">Code:</span> <span class="font-semibold"><?php echo e($order->coupon_code); ?></span></p>
                        <p class="text-emerald-700"><span class="text-emerald-600/60">Discount:</span> <span class="font-semibold">-<?php echo e($currency_symbol); ?><?php echo e(number_format($order->discount_amount, 2)); ?></span></p>
                    </div>
                </div>
            <?php endif; ?>
        </div>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\idb-project\PulseTrade\resources\views\admin\orders\show.blade.php ENDPATH**/ ?>