...
<?php $component = App\View\Components\StorefrontLayout::resolve(['title' => 'Shop All Products — PulseTrade'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
    ...
    <div class="bg-navy-950 text-white py-14">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p class="text-ivory/60 mt-2 text-sm"><?php echo e($products->count()); ?> products across <?php echo e($categories->count()); ?> categories</p>
        </div>
    </div>
        ...
        <aside class="space-y-8">
            <div>
                ...
                <ul class="space-y-2.5 text-sm">
                    <li><a href="<?php echo e(url('/shop')); ?>" class="flex justify-between text-pulse-500 font-semibold">All Products <span><?php echo e($products->count()); ?></span></a></li>
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <a href="<?php echo e(url('/shop?category='.$cat->slug)); ?>" class="flex justify-between text-navy-700 hover:text-pulse-500 transition-colors">
                                <?php echo e($cat->name); ?> <span class="text-navy-700/40"><?php echo e($cat->products_count); ?></span>
                            </a>
                        </li>
...
<?php endif; ?>
<?php /**PATH E:\xampp\htdocs\idb-project\PulseTrade\resources\views\shop\index.blade.php ENDPATH**/ ?>