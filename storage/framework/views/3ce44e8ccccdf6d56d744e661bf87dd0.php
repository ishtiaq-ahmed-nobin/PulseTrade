...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" name="sale_price" id="sale_price" value="<?php echo e(old('sale_price')); ?>" step="0.01" min="0"
                           class="w-full rounded-lg border-navy-200 text-navy-900 focus:border-pulse-500 focus:ring-pulse-500"
...
unset($__errorArgs, $__bag); ?>
                <div class="mt-3">
                    ...
                    <input type="url" name="image_url" id="image_url" value="<?php echo e(old('image_url')); ?>"
                           class="w-full rounded-lg border-navy-200 text-navy-900 focus:border-pulse-500 focus:ring-pulse-500"
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\idb-project\PulseTrade\resources\views\admin\products\create.blade.php ENDPATH**/ ?>