...
<?php $component = App\View\Components\StorefrontLayout::resolve(['title' => 'My Account — PulseTrade'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
    ...
    <div class="bg-navy-950 text-white py-14">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <p class="text-ivory/60 mt-2 text-sm">Welcome back, <?php echo e($user->name); ?></p>
        </div>
    </div>
        ...
        <aside class="space-y-6">
            <div class="rounded-2xl bg-white border border-navy-100 p-6 text-center">
                <div class="mx-auto w-16 h-16 rounded-full bg-pulse-100 flex items-center justify-center">
                    <span class="font-display font-bold text-xl text-pulse-600"><?php echo e(substr($user->name, 0, 2)); ?></span>
                </div>
                <p class="font-semibold text-navy-900 mt-3"><?php echo e($user->name); ?></p>
                <p class="text-xs text-navy-700/50 mt-0.5"><?php echo e($user->email); ?></p>
            </div>

            <nav class="rounded-2xl bg-white border border-navy-100 divide-y divide-navy-50 text-sm">
                <a href="<?php echo e(route('user.dashboard')); ?>" class="flex items-center gap-3 px-5 py-3.5 text-pulse-600 font-semibold bg-pulse-50/50">
                ...
                <a href="<?php echo e(route('shop.index')); ?>" class="flex items-center gap-3 px-5 py-3.5 text-navy-700 hover:text-pulse-600 transition-colors">
        ...
        <div class="space-y-10">
            ...
            <section>
                ...
                <div class="rounded-2xl bg-white border border-navy-100 p-6">
                    ...
                    <form method="POST" action="<?php echo e(route('user.profile.update')); ?>" class="hidden mt-6 pt-6 border-t border-navy-100 space-y-4">
                        <?php echo csrf_field(); ?>
                        <div>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="address" rows="2" class="mt-1 w-full rounded-xl border-navy-100 text-sm focus:border-pulse-500 focus:ring-pulse-500"><?php echo e(old('address', $user->address)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <section>
                ...
                <div class="rounded-2xl bg-white border border-navy-100 p-6">
                    <form method="POST" action="<?php echo e(route('user.password.update')); ?>" class="space-y-4 max-w-md">
                        <?php echo csrf_field(); ?>
                        <div>
            ...
            <section id="orders">
                ...
                <?php if($orders->isEmpty()): ?>
                    <div class="rounded-2xl bg-white border border-navy-100 p-12 text-center">
                        ...
                        <a href="<?php echo e(route('shop.index')); ?>" class="inline-block mt-4 text-sm font-semibold text-pulse-500 hover:text-pulse-400">Start shopping →</a>
                    </div>
                <?php else: ?>
                    <div class="space-y-4">
                        <?php $__currentLoopData = $orders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $order): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="rounded-2xl bg-white border border-navy-100 p-5">
                                <div class="flex flex-wrap items-center justify-between gap-3">
                                    <div>
                                        <p class="text-sm font-semibold text-navy-900"><?php echo e($order->order_number); ?></p>
                                        <p class="text-xs text-navy-700/50 mt-0.5"><?php echo e($order->created_at->format('M d, Y')); ?></p>
                                    </div>
                                    <div class="flex items-center gap-3">
                                        <span class="text-xs px-3 py-1 rounded-full font-semibold <?php echo e($statusBadges[$order->status] ?? 'bg-gray-100 text-gray-800'); ?>">
                                            <?php echo e(ucfirst($order->status)); ?>

                                        </span>
                                        <span class="text-sm font-bold text-navy-900"><?php echo e($currency_symbol); ?><?php echo e(number_format($order->total_amount, 2)); ?></span>
                                    </div>
                                </div>
                                    ...
                                    <div class="mt-3 pt-3 border-t border-navy-50 flex flex-wrap gap-3">
                                        <?php $__currentLoopData = $order->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="text-xs text-navy-700/60 bg-ivory px-2.5 py-1 rounded-full">
                                                <?php echo e($item->product?->name ?? 'Product'); ?> × <?php echo e($item->quantity); ?>
...
<?php endif; ?>
<?php /**PATH E:\xampp\htdocs\idb-project\PulseTrade\resources\views/user/dashboard.blade.php ENDPATH**/ ?>