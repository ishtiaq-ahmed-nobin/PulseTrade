        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex gap-5 overflow-x-auto pb-4 -mx-4 px-4 snap-x">
                <?php $__currentLoopData = $featured; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(url('/shop/product/'.$product->slug)); ?>" class="snap-start shrink-0 w-64 rounded-2xl border border-navy-100 bg-white overflow-hidden hover:shadow-lg hover:shadow-navy-900/5 transition-shadow">
                        ...
                        <?php endif; ?>
                        <div class="p-4">
                            <p class="text-sm font-semibold text-navy-900 leading-snug"><?php echo e($product->name); ?></p>
...
<?php endif; ?>
<?php /**PATH E:\xampp\htdocs\idb-project\PulseTrade\resources\views\home.blade.php ENDPATH**/ ?>