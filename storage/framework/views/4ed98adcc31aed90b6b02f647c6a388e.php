...
<?php $component = App\View\Components\StorefrontLayout::resolve(['title' => 'About Us — PulseTrade'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component->withAttributes([]); ?>
                ...
                <?php $__currentLoopData = $values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="rounded-2xl bg-white border border-navy-100 p-7 hover:shadow-lg hover:shadow-navy-900/5 transition-shadow">
                        <div class="w-11 h-11 rounded-full bg-pulse-50 flex items-center justify-center mb-4">
                            <svg class="w-5 h-5 text-pulse-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><?php echo $val['icon']; ?></svg>
                        </div>
                        <h3 class="font-display font-semibold text-lg text-navy-900"><?php echo e($val['title']); ?></h3>
                        <p class="text-sm text-navy-700/60 mt-2 leading-relaxed"><?php echo e($val['body']); ?></p>
                    </div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 text-center">
                <?php $__currentLoopData = $stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div>
                        <p class="font-display font-bold text-4xl text-white"><?php echo e($stat['number']); ?></p>
                        <p class="text-sm text-ivory/50 mt-2"><?php echo e($stat['label']); ?></p>
                    </div>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        </div>
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <?php $__currentLoopData = $team; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="text-center">
                    <div class="w-28 h-28 rounded-full mx-auto bg-gradient-to-br <?php echo e($member['gradient']); ?> flex items-center justify-center mb-4">
                        <span class="font-display font-bold text-2xl text-white"><?php echo e(substr($member['name'], 0, 1)); ?></span>
                    </div>
                    <p class="font-display font-semibold text-navy-900"><?php echo e($member['name']); ?></p>
                    <p class="text-xs text-navy-700/50 mt-1"><?php echo e($member['role']); ?></p>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </section>
    ...
    <section class="bg-ivory py-20">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="<?php echo e(url('/shop')); ?>" class="inline-flex mt-8 px-8 py-4 rounded-full bg-pulse-500 hover:bg-pulse-400 text-white font-semibold text-sm transition-colors">
                Shop the Collection
            </a>
        </div>
    </section>
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\idb-project\PulseTrade\resources\views/about.blade.php ENDPATH**/ ?>