...
<body class="font-body antialiased bg-ivory text-navy-900 min-h-screen flex">
    ...
    <div class="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12">
        <div class="w-full max-w-sm" x-data="{ tab: '<?php echo e(session('register_tab') ? 'register' : 'login'); ?>' }">
            ...
            <form x-show="tab === 'login'" method="POST" action="<?php echo e(route('login')); ?>" class="space-y-5">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex items-center justify-between">
                    ...
                    <?php if(Route::has('password.request')): ?>
                        <a href="<?php echo e(route('password.request')); ?>" class="text-xs font-semibold text-pulse-500 hover:text-pulse-400">
                            Forgot password?
                        </a>
                    <?php endif; ?>
                </div>
            ...
            <form x-show="tab === 'register'" method="POST" action="<?php echo e(route('register')); ?>" class="space-y-5">
                <?php echo csrf_field(); ?>

                <div>
                    <label for="reg-name" class="text-xs font-semibold text-navy-700/70">Full Name</label>
                    <input id="reg-name" type="text" name="name" value="<?php echo e(old('name')); ?>" required autofocus
                        class="mt-1 w-full rounded-xl border-navy-100 text-sm focus:border-pulse-500 focus:ring-pulse-500 placeholder:text-navy-700/30"
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input id="reg-email" type="email" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="username"
                        class="mt-1 w-full rounded-xl border-navy-100 text-sm focus:border-pulse-500 focus:ring-pulse-500 placeholder:text-navy-700/30"
                        placeholder="you@example.com">
                    <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
...
<?php /**PATH E:\xampp\htdocs\idb-project\PulseTrade\resources\views/auth/login.blade.php ENDPATH**/ ?>