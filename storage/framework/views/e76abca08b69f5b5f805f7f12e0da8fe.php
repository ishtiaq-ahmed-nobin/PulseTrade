...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Period: <?php echo e($from->format('M d, Y')); ?> — <?php echo e($to->format('M d, Y')); ?></p>
        </div>

        <div class="summary-grid">
            <div class="summary-card">
                <div class="label">Total Revenue</div>
                <div class="value"><?php echo e($currencySymbol); ?><?php echo e(number_format($totalRevenue, 2)); ?></div>
            </div>
            <div class="summary-card">
            ...
            <div class="summary-card">
                ...
                <div class="value"><?php echo e($paidOrders); ?></div>
            </div>
            <div class="summary-card">
                <div class="label">Avg Order Value</div>
                <div class="value"><?php echo e($currencySymbol); ?><?php echo e(number_format($avgOrderValue, 2)); ?></div>
            </div>
        </div>

        <div class="section">
            <div class="section-title">Daily Sales</div>
            <?php if($dailySales->count()): ?>
                <table>
                    <thead>
                        <tr>
                            <th>Date</th>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $dailySales; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="text-right"><?php echo e($day->orders); ?></td>
                                <td class="text-right"><?php echo e($currencySymbol); ?><?php echo e(number_format($day->revenue, 2)); ?></td>
                            </tr>
                    ...
                    <tbody>
                        <?php $__currentLoopData = $topProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="text-right"><?php echo e($product->qty_sold); ?></td>
                                <td class="text-right"><?php echo e($currencySymbol); ?><?php echo e(number_format($product->total_revenue, 2)); ?></td>
                            </tr>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </tbody>
                </table>
        ...
        <div class="footer">
            Generated on <?php echo e(now()->format('M d, Y \a\t g:i A')); ?> — PulseTrade Analytics
        </div>
    </div>
</body>
</html>
<?php /**PATH C:\xampp\htdocs\idb-project\PulseTrade\resources\views/admin/reports/sales-pdf.blade.php ENDPATH**/ ?>